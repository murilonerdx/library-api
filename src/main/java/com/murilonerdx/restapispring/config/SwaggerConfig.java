...
public class SwaggerConfig {
    ...
    private static final String BASE_PACKAGE = "com.murilonerdx.restapispring";
    private static final String API_TITLE = "Spring boot rest api";
    private static final String API_DESCRIPTION = "REST API for complete";
    private static final String API_VERSION = "1.0.0";
    private static final String CONTACT_NAME = "Murilo Pereira";
